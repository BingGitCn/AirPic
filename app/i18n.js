...
export const dict = {
  zh: {
    ...
    'file.folder.empty': '未选文件夹，文件将无法接收',
    'hero.title.a': '快门一按，',
    'hero.title.b': '即达。',
    ...
    'send.title': '发给手机',
    'send.idle': '连接后可发送',
    'send.active': '已连接，可发送文件',
    'send.drop': '拖入文件 · 点击选择 · 粘贴',
    'link.copy': '复制配对链接',
    'link.copied': '已复制',
    'act.in': '收',
    'act.out': '发',
  ...
  en: {
    ...
    'file.folder.empty': 'No folder — files can’t be received',
    ...
    'send.title': 'Send to phone',
    'send.idle': 'Connects once a phone joins',
    'send.active': 'Connected — files go to the phone',
    'send.drop': 'Drop files · click to choose · paste',
