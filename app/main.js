...
import { apply, getLang, setLang } from './i18n.js?v=14';
import * as lib from './lib.js?v=14';
import { initReceiver } from './receiver.js?v=14';
import { initSender } from './sender.js?v=14';
