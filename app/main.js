...
import { apply, getLang, setLang } from './i18n.js?v=11';
import * as lib from './lib.js?v=11';
import { initReceiver } from './receiver.js?v=11';
import { initSender } from './sender.js?v=11';
